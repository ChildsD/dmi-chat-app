...
// in simulator we redefine to format for chat Developer console
...
{\
	NSString * exceptionName = [@"org.chat." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.chat";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIchatNativeItemNone = -1, 
	UIchatNativeItemSpinner = -2,
	UIchatNativeItemProgressBar = -3,
	
	UIchatNativeItemSlider = -4,
	UIchatNativeItemSwitch = -5,
	UIchatNativeItemMultiButton = -6,
	UIchatNativeItemSegmented = -7,
	
	UIchatNativeItemTextView = -8,
	UIchatNativeItemTextField = -9,
	UIchatNativeItemSearchBar = -10,
	
	UIchatNativeItemPicker = -11,
	UIchatNativeItemDatePicker = -12,
	
	UIchatNativeItemInfoLight = -13,
	UIchatNativeItemInfoDark = -14,
	
	UIchatNativeItemDisclosure = -15,
	
	UIchatNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all chat instances of
