...
/**
 The base class for all chat modules
 */
...
/**
 chat Platform calls this method on startup.
 */
-(void)startup;

/**
 chat Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 chat Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 chat Platform calls this method on resume.
 @param sender The sender of the event.
 */
