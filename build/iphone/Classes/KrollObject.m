 ...
 * Copyright (c) 2009-2011 by chat, Inc. All Rights Reserved.
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[chatObject class]])
		{
			for (NSString *key in [[(chatObject*)o modules] allKeys])
			{
